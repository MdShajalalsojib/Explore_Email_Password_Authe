...
const Home = () => {
    return (
        <div>
             <div className='bg-gray-600 rounded-2xl mt-2 p-5'>
               <div>
                <div>
                <h4 className='text-cyan-400'>Hi, there!</h4>
                <h1 className='hero_title text-green-400 font-bole text-[50px]'>Good Evening </h1>
                <h2 class ="hero_designation">
                    "I am"
                     <span class="auto_type"> A Web Developer</span>
                     <span class ="typed-cursor" aria-hidden="true">|</span>
                     </h2>
                 
                <button className="btn btn-wide mt-8">Download Resume</button>
                <div className='flex justify-start gap-6 mt-8'>
                    <div>
                          <a href="https://www.facebook.com/share/1EvTktYurR/">
                    ...
                    <div>
                        <a href="https://github.com/MdShajalalsojib"> 
                    ...
                    <div>
                        <a href="https://www.linkedin.com/in/md-shahjalal-sojib-327578352?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"> 
              ...
              <div>
                    <img src='../Home/img/sojib.png'  alt="" />
              </div>
               </div>
             </div>
        </div>
